...
function [Dq,Cq,Gq,nJp] = matrizesBancada(q1, q2, q3, q4, qdot1, qdot2, qdot3, qdot4)
  g = 9.81;
  %m = [2.76134162, 0.154325208, 0.11503306, 0.55978948]; %Revisado
  %m = [2.76134162, 0, 0, 1.278]; %Revisado
  m= [2.76134162, 0.154325208, 0.11503306, 1.0086];
  l = [    0, 0.595, 0.173,     0];
  
  Ix= [0.004165125, 0.001006095, 0.00007608364, 0.01339627]; % Revisado
  
  Iy= [0.28761702, 0.00001835292, 0.00008259913, 0.00061324]; %Revisado
  
  Iz= [ 0.289994709, 0.001002423, 0.0000172333, 0.01358909]; %Revisado
   
%   m = [2.761, 0.154, 0.115, 1.278];
%   l = [    0, 0.595, 0.173,     0];
%   Ix= [0.004165125, 0.001006095, 0.00001723333, 0.0187];
%   Iy= [0.289994709, 0.289994709, 0.00008259913, 0.00051408];
