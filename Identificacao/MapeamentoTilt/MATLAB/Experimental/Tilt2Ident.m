...
leg1=legend('Dados experimentais','Curva Ajustada - \alpha_2[PWM]=0.0000000000396*PWM²-0.000214638*PWM+280.823582')

set(leg1,'Interpreter','latex')
grid on
print('Tilt2_grau2','-dpdf','-bestfit')
...
leg1=legend('Dados experimentais','Curva Ajustada - alpha_2[PWM]=-0.05613883*PWM+124.17317422')

set(leg1,'Interpreter','latex')
grid on
print('Tilt2_grau1','-dpdf','-bestfit')
