...
% Tilt do braco maior marcado como m1
% potenciometro
...
plot(x1,y1,'r*');
ylabel('Angulo$\hspace{0.5em}$[${}^\circ$]', 'interpreter','latex');
xlabel('$Leitura$\hspace{0.5em}$ADC$\hspace{0.5em}$[10$\hspace{0.5em}$bits]$', 'interpreter','latex');
