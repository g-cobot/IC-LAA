...
theta4 = ensaio1(100:500,3)
theta4_dot = ensaio1(100:500,6)
...
subplot(2,1,1);
plot([0:size(theta4)-1]*Ts,theta4*-1,'Color','[0 0.4470 0.7410]')
...
subplot(2,1,2);
plot([0:size(theta4_dot)-1]*Ts,theta4_dot *-1,'Color','[0 0.4470 0.7410]')
