...
figura.Children(2).XTick= 0:1:10
figura.Children(2).XLim= [0 10]
figura.Children(2).XLabel.String='Tempo\hspace{0.5em}[s]'
figura.Children(2).XLabel.Interpreter='latex'
%Arrumando o eixo Y
figura.Children(2).YGrid=1
figura.Children(2).YTick= linspace(0,0.12,5)
figura.Children(2).YLim= [0 0.12]
figura.Children(2).YLabel.String='$\theta_2$\hspace{0.5em}[rad]'
